            ...
            <div style="display: flex;grid-template-columns: auto auto 1fr;z-index: 2;overflow-y: hidden;flex-grow: 1;">
                ...
                <div id="appModuleMenu" class="app-module-menu xisClosed" style="background:rgb(255, 255, 255, 0.65);xpadding-top: 50px;xpadding-bottom: 50px;display: flex;flex-direction:column">
                    <div id="appModuleMenuContent1" class="app-module-menu-content app-modules xisClosed" style="min-width: 65px;background:#fff0;flex-grow:1;box-sizing: border-box;row-gap: 10px;flex-direction: column;justify-content: center;border-right: 1px solid rgb(230, 230, 230);">
                      ...
                      <div v-on:click="loadComponent('People-component')" id="People-component-module" xv-on:clickPrev="signalShowChat('chat_menu')" style="user-select:none;display: flex;align-items: center;flex-direction: column;font-size: 0.65rem;gap: 5px;">
                          <div style="transform: scale(0.85);border: 3px solid rgb(230 230 230);background: rgb(234 234 234);border-radius: 50%;position: relative;padding: 10px;display: flex;">
                            <span class="lnr lnr-pie-chart" style="transform: scale(1.25);"></span>
                          </div>
                          <div style="transform: scale(0.85);text-transform: uppercase;font-size: 0.45rem;letter-spacing: 1px;;user-select:none">People</div>
                      </div>
...
<script>
  ...
  methods: {
    ...
    loadComponent (name) {
      ...
      } else if (name === 'People-component') {
        this.isTaskView = false;
        this.currentTabComponent = People;
    ...
    switchApp (appName) {
      if (appName === 'settings') { window.location = '/admin'; } else if (appName === 'tasks') { window.location = '/app'; } else if (appName === 'channels') { window.location = '/channels'; } else if (appName === 'calendar') { window.location = '/calendar'; } else if (appName === 'businessbench') { window.location = '/businessbench'; } else if (appName === 'dashboard') { window.location = '/dashboard'; } else if (appName === 'Clients') { window.location = '/Clients'; } else if (appName === 'People') { window.location = '/People'; }
    },
