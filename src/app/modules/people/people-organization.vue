...
<div class="form-main">
    <label class="form_label">Hotkup
        List</label>
    <select class="form_inputs"
        placeholder="Hotkup List" v-model="orgData.hotkupList">
...
<div class="form-main">
    <label
        class="form_label">Organization
        Name</label>
    <input class="form_inputs"
        value="COKE_COLA"
        placeholder="Organization Name" v-model="orgData.organizationName"/>
</div>
<div class="form-main">
    ...
    <input class="form_inputs"
        ...
        placeholder="Job Role" v-model="orgData.jobRole"/>
</div>
<div class="form-main">
    <label
        class="form_label">Telephone</label>
    <input class="form_inputs"
        value="258141"
        placeholder="Telephone" v-model="orgData.telephone"/>
</div>
<div class="form-main">
    <label
...
<div id="save_can_btns">
    <button
        class="save_btn" v-on:click="saveOrganization">SUBMIT</button>
    <button
