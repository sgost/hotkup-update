<template>
    <div style="display:flex;align-items:center;justify-content:center;flex-direction: row;min-width: 50px;display:none">
        ...
        src="https://miro.medium.com/max/1400/0*o0-6o1W1DKmI5LbX.png"
         width="25" height="25"
      ...
      <div class="list-item-row-3" style="place-items: end flex-start;overflow: hidden;">
        <div style="display: flex;column-gap: 5px;width: 100%;justify-content: space-between;">
          ...
          <div style="display: flex;column-gap: 2px;">
              ...
              <div class="task-created-date critical" style="display:flex;overflow: hidden;max-width: 50%;text-transform: none;white-space: pre;border: 0px solid rgb(239, 239, 239);padding: 2px 10px;border-radius: 20px;background-color: rgb(233 30 99 / 40%);color: white;">
              {{item.month}}</div>
          </div>
        </div>
      </div>
