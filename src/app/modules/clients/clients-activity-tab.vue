                    ...
                    <div v-show="isFileChosen" style="overflow-x: hidden;display: flex;flex-direction: column;row-gap: 5px;margin-top: 5px;">
                        <div v-for="selectedFile,index in chosenFiles" style="display: flex;column-gap: 5px;background: white;width: max-content;padding: 2px 10px;border-radius: 25px;border: 1px solid #8080804a;">
                            ...
                            <div v-show="selectedFile.isUploaded!==null && selectedFile.isUploaded" uk-tooltip="File uploaded" v-on:click="removeAttachedFileAtIndex(index)" style="place-self: center flex-start;">
                                <svg width="15" height="15" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="check">
                                    <polyline fill="none" stroke="#47adf9" stroke-width="2" points="4,10 8,15 17,4"></polyline>
                                </svg>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="activity_description">
                        ...
                        <div v-if="activity.type=='NEW_COMMENT'">
                            ...
                            <div v-on:click="toggleActivityDetail($event)" style="cursor:pointer;user-select:none;font-weight: normal;position: relative;min-height: 35px;display: flex;justify-content:flex-start;align-items: center;">
                                ...
                                <span v-bind:data-activity-id="activity.id" v-bind:data-task-id="activity.taskId" v-bind:data-createdby-id="activity.createdById" v-bind:data-activity-type="activity.type" class="openActivityDetailTrigger activity_detail_trigger" style="user-select: none;" title="" aria-expanded="false">
                                    <svg style="pointer-events: none;" width="17" height="17" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="chevron-up">
                            ...
                            <div class="activity_detail hide_activity_detail" style="font-weight: normal;font-size: 0.75rem;color: rgb(179, 179, 179);margin-top: 15px;margin-bottom: 15px;" v-if="activity.hasAttachments!==null && activity.hasAttachments===true">
                                <div v-for="attachment in activity.formAttachments">
                                    <div style="display: flex;column-gap: 5px;align-items: center;">
                                        <span uk-tooltip="Upload Document.<br> Only .csv, .xls, .xlsx, .doc, .docx, .pdf files accepted." data-v-6ad5a684="" style="cursor: pointer; display: grid; place-self: center flex-start;" title="" aria-expanded="false"><svg class="svg-inline--fa fa-paperclip fa-w-14" data-v-6ad5a684="" style="padding: 0px; font-size: 12px; color: rgb(141, 124, 124); display: grid; place-self: center;" aria-hidden="true" data-fa-processed="" data-prefix="fas" data-icon="paperclip" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            ...
                                            </svg><!-- <i class="fas fa-paperclip" data-v-6ad5a684="" style="padding: 0px; font-size: 18px; color: rgb(141, 124, 124); display: grid; place-self: center;"></i> --></span>
